...
class TestGamesApi(unittest.TestCase):
    ...
    def test_get_adjusted_game_preview(self) -> None:
        """Test case for get_adjusted_game_preview
    ...
    def test_get_game_schedule(self) -> None:
        """Test case for get_game_schedule
