...
```sh
pip install cfbd@5.1.0a1
```
(you may need to run `pip` with root permission: `sudo pip install cfbd@5.1.0a1`)
...
*StatsApi* | [**get_adjusted_team_season_stats**](docs/StatsApi.md#get_adjusted_team_season_stats) | **GET** /stats/team/season/adjusted | 
