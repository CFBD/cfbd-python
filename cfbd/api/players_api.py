...
class PlayersApi:
    ...
    @validate_arguments
    def get_player_season_overview(self, year : Annotated[StrictInt, Field(..., description="Required year filter")], player_id : Annotated[StrictInt, Field(..., description="Required player id filter")], **kwargs) -> PlayerSeasonOverview:  # noqa: E501
        """get_player_season_overview  # noqa: E501

        Retrieves a player season overview with box score, usage, and PPA data  # noqa: E501
    ...
    @validate_arguments
    def get_player_season_overview_with_http_info(self, year : Annotated[StrictInt, Field(..., description="Required year filter")], player_id : Annotated[StrictInt, Field(..., description="Required player id filter")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_player_season_overview  # noqa: E501
