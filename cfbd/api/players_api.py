...
class PlayersApi:
    ...
    @validate_arguments
    def get_player_season_overview(self, year : Annotated[StrictInt, Field(..., description="Season year.")], player_id : Annotated[StrictInt, Field(..., description="Player ID.")], **kwargs) -> PlayerSeasonOverview:  # noqa: E501
        """get_player_season_overview  # noqa: E501

        Returns a player season overview with box score, usage, and Predicted Points Added (PPA) data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_player_season_overview(year, player_id, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: PlayerSeasonOverview
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_player_season_overview_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_player_season_overview_with_http_info(year, player_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_player_season_overview_with_http_info(self, year : Annotated[StrictInt, Field(..., description="Season year.")], player_id : Annotated[StrictInt, Field(..., description="Player ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_player_season_overview  # noqa: E501
        ...
        >>> thread = api.get_player_season_overview_with_http_info(year, player_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PlayerSeasonOverview, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_player_season_overview" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PlayerSeasonOverview",
        }

        return self.api_client.call_api(
            '/player/season/overview', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_player_usage(self, year : Annotated[StrictInt, Field(..., description="Season year.")], conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, player_id : Annotated[Optional[StrictInt], Field(description="Player ID.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`. Defaults to `false`.")] = None, **kwargs) -> List[PlayerUsage]:  # noqa: E501
        """get_player_usage  # noqa: E501

        Returns player usage metrics for a season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_returning_production(self, year : Annotated[Optional[StrictInt], Field(description="Season year. Required unless `team` is specified.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name. Required unless `year` is specified.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference name or abbreviation.")] = None, **kwargs) -> List[ReturningProduction]:  # noqa: E501
        ...
        Returns returning production metrics by team and season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_transfer_portal(self, year : Annotated[StrictInt, Field(..., description="Season year.")], **kwargs) -> List[PlayerTransfer]:  # noqa: E501
        """get_transfer_portal  # noqa: E501

        Returns transfer portal entries for a season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_transfer_portal_with_http_info(self, year : Annotated[StrictInt, Field(..., description="Season year.")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_transfer_portal  # noqa: E501
    ...
    @validate_arguments
    def search_players(self, search_term : Annotated[StrictStr, Field(..., description="Full or partial player name.")], year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, **kwargs) -> List[PlayerSearchResult]:  # noqa: E501
        """search_players  # noqa: E501

        Returns up to 100 players whose names match the search term.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param search_term: Full or partial player name. (required)
    ...
    @validate_arguments
    def search_players_with_http_info(self, search_term : Annotated[StrictStr, Field(..., description="Full or partial player name.")], year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """search_players  # noqa: E501
