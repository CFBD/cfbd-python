...
class GamesApi(object):
    ...
    def get_game_weather(self, year, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_game_weather_with_http_info(year, **kwargs)  # noqa: E501
        else:
            (data) = self.get_game_weather_with_http_info(year, **kwargs)  # noqa: E501
            return data

    def get_game_weather_with_http_info(self, year, **kwargs):  # noqa: E501
        """Game weather information (Patreon only)  # noqa: E501

        Weather information for the hour of kickoff  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_game_weather_with_http_info(year, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('year' not in params or
                                                       params['year'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `year` when calling `get_game_weather`")  # noqa: E501
