...
class RecruitingApi:
    ...
    @validate_arguments
    def get_aggregated_team_recruiting_ratings(self, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference name or abbreviation.")] = None, recruit_type : Annotated[Optional[RecruitClassification], Field(description="Recruit classification. Defaults to `HighSchool`.")] = None, start_year : Annotated[Optional[StrictInt], Field(description="Earliest recruiting class year. Defaults to 2000.")] = None, end_year : Annotated[Optional[StrictInt], Field(description="Latest recruiting class year. Defaults to the current year.")] = None, **kwargs) -> List[AggregatedTeamRecruiting]:  # noqa: E501
        """get_aggregated_team_recruiting_ratings  # noqa: E501

        Returns recruiting ratings aggregated by team and position group.  # noqa: E501
        ...
        :type conference: str
        :param recruit_type: Recruit classification. Defaults to `HighSchool`.
        :type recruit_type: RecruitClassification
        :param start_year: Earliest recruiting class year. Defaults to 2000.
        :type start_year: int
        :param end_year: Latest recruiting class year. Defaults to the current year.
        :type end_year: int
    ...
    @validate_arguments
    def get_aggregated_team_recruiting_ratings_with_http_info(self, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference name or abbreviation.")] = None, recruit_type : Annotated[Optional[RecruitClassification], Field(description="Recruit classification. Defaults to `HighSchool`.")] = None, start_year : Annotated[Optional[StrictInt], Field(description="Earliest recruiting class year. Defaults to 2000.")] = None, end_year : Annotated[Optional[StrictInt], Field(description="Latest recruiting class year. Defaults to the current year.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_aggregated_team_recruiting_ratings  # noqa: E501
    ...
    @validate_arguments
    def get_recruits(self, year : Annotated[Optional[StrictInt], Field(description="Recruiting class year. Required unless `team` is specified.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name. Required unless `year` is specified.")] = None, position : Annotated[Optional[StrictStr], Field(description="Position category.")] = None, state : Annotated[Optional[StrictStr], Field(description="State or province abbreviation.")] = None, classification : Annotated[Optional[RecruitClassification], Field(description="Recruit classification. Defaults to `HighSchool`.")] = None, **kwargs) -> List[Recruit]:  # noqa: E501
        """get_recruits  # noqa: E501

        Returns player recruiting rankings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_team_recruiting_rankings(self, year : Annotated[Optional[StrictInt], Field(description="Recruiting class year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, **kwargs) -> List[TeamRecruitingRanking]:  # noqa: E501
        """get_team_recruiting_rankings  # noqa: E501

        Returns team recruiting rankings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_team_recruiting_rankings_with_http_info(self, year : Annotated[Optional[StrictInt], Field(description="Recruiting class year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_team_recruiting_rankings  # noqa: E501
