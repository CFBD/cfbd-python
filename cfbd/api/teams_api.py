...
class TeamsApi:
    ...
    @validate_arguments
    def get_roster(self, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, year : Annotated[Optional[StrictInt], Field(description="Optional year filter, defaults to 2025")] = None, **kwargs) -> List[RosterPlayer]:  # noqa: E501
    ...
    @validate_arguments
    def get_roster_with_http_info(self, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, year : Annotated[Optional[StrictInt], Field(description="Optional year filter, defaults to 2025")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_roster  # noqa: E501
