...
class TeamsApi:
    ...
    @validate_arguments
    def get_roster(self, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, year : Annotated[Optional[StrictInt], Field(description="Optional year filter, defaults to 2025")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Optional filter to only include players from FBS or FCS teams")] = None, **kwargs) -> List[RosterPlayer]:  # noqa: E501
    ...
    @validate_arguments
    def get_roster_with_http_info(self, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, year : Annotated[Optional[StrictInt], Field(description="Optional year filter, defaults to 2025")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Optional filter to only include players from FBS or FCS teams")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_roster  # noqa: E501
    ...
    @validate_arguments
    def get_teams_ats(self, year : Annotated[StrictInt, Field(..., description="Required year filter")], conference : Annotated[Optional[StrictStr], Field(description="Optional conference filter")] = None, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, **kwargs) -> List[TeamATS]:  # noqa: E501
        """get_teams_ats  # noqa: E501

        Retrieves against-the-spread (ATS) summary by team  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_teams_ats_with_http_info(self, year : Annotated[StrictInt, Field(..., description="Required year filter")], conference : Annotated[Optional[StrictStr], Field(description="Optional conference filter")] = None, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_teams_ats  # noqa: E501
