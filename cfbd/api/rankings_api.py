...
class RankingsApi:
    ...
    @validate_arguments
    def get_rankings(self, year : Annotated[StrictInt, Field(..., description="Required year filter")], season_type : Annotated[Optional[SeasonType], Field(description="Optional season type filter")] = None, week : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Optional week filter")] = None, poll : Annotated[Optional[RankingPoll], Field(description="Optional poll filter")] = None, latest : Annotated[Optional[StrictBool], Field(description="Return the latest CFP snapshot, preferring the marked final")] = None, final : Annotated[Optional[StrictBool], Field(description="Return the marked final CFP snapshot")] = None, **kwargs) -> List[PollWeek]:  # noqa: E501
