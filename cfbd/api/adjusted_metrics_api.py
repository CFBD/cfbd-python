...
class AdjustedMetricsApi:
    ...
    @validate_arguments
    def get_adjusted_player_passing_stats(self, year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, **kwargs) -> List[PlayerWeightedEPA]:  # noqa: E501
        """get_adjusted_player_passing_stats  # noqa: E501

        Returns opponent-adjusted player passing metrics.  # noqa: E501
    ...
    def get_adjusted_player_rushing_stats(self, year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, **kwargs) -> List[PlayerWeightedEPA]:  # noqa: E501
        ...
        Returns opponent-adjusted player rushing metrics.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_adjusted_team_season_stats(self, year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference name or abbreviation.")] = None, **kwargs) -> List[AdjustedTeamMetrics]:  # noqa: E501
        ...
        Returns opponent-adjusted team statistics by season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_kicker_paar(self, year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, **kwargs) -> List[KickerPAAR]:  # noqa: E501
        """get_kicker_paar  # noqa: E501

        Returns Points Added Above Replacement (PAAR) ratings for kickers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_kicker_paar_with_http_info(self, year : Annotated[Optional[StrictInt], Field(description="Season year.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_kicker_paar  # noqa: E501
