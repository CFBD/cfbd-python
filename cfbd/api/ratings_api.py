...
class RatingsApi(object):
    ...
    def get_elo_ratings(self, **kwargs):  # noqa: E501
        ...
        :param object season_type: Maximum season type to consider (defaults to regular if week is specified else defaults to postseason)
    ...
    def get_elo_ratings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['year', 'week', 'season_type', 'team', 'conference']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_fpi_ratings(self, **kwargs):  # noqa: E501
        """Historical FPI ratings  # noqa: E501

        FPI rating data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fpi_ratings(async_req=True)
        >>> result = thread.get()
        ...
        :param str team: Team filter
        :param str conference: Conference filter
        :return: list[TeamFPIRating]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_fpi_ratings_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_fpi_ratings_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_fpi_ratings_with_http_info(self, **kwargs):  # noqa: E501
        """Historical FPI ratings  # noqa: E501

        FPI rating data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fpi_ratings_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[TeamFPIRating]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
