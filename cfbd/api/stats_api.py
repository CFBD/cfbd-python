...
class StatsApi:
    ...
    @validate_arguments
    def get_game_havoc_stats(self, year : Annotated[Optional[StrictInt], Field(description="Year filter, required if team not specified")] = None, team : Annotated[Optional[StrictStr], Field(description="Team filter, required if year not specified")] = None, week : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Optional week filter")] = None, opponent : Annotated[Optional[StrictStr], Field(description="Optional opponent filter")] = None, season_type : Annotated[Optional[SeasonType], Field(description="Optional season type filter")] = None, **kwargs) -> List[GameHavocStats]:  # noqa: E501
        """get_game_havoc_stats  # noqa: E501

        Retrieves havoc statistics aggregated by game  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_player_season_success_rates(self, year : Annotated[Optional[StrictInt], Field(description="Year filter, required if playerId not specified")] = None, conference : Annotated[Optional[StrictStr], Field(description="Optional conference abbreviation filter")] = None, team : Annotated[Optional[StrictStr], Field(description="Optional team filter")] = None, player_id : Annotated[Optional[StrictInt], Field(description="Player ID filter, required if year not specified")] = None, season_type : Annotated[Optional[SeasonType], Field(description="Optional season type filter")] = None, start_week : Annotated[Optional[StrictInt], Field(description="Optional starting week range")] = None, end_week : Annotated[Optional[StrictInt], Field(description="Optional ending week range")] = None, threshold : Annotated[Optional[StrictInt], Field(description="Optional minimum credited passing plus rushing plays")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Optional flag to exclude garbage time plays")] = None, **kwargs) -> List[PlayerSeasonSuccessRate]:  # noqa: E501
        """get_player_season_success_rates  # noqa: E501

        Retrieves player passing and rushing success rates by season  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
