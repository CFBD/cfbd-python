...
class DraftApi:
    ...
    @validate_arguments
    def get_draft_picks(self, year : Annotated[Optional[StrictInt], Field(description="Draft year.")] = None, team : Annotated[Optional[StrictStr], Field(description="NFL team name.")] = None, school : Annotated[Optional[StrictStr], Field(description="College team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="College conference name or abbreviation.")] = None, position : Annotated[Optional[StrictStr], Field(description="Position category.")] = None, **kwargs) -> List[DraftPick]:  # noqa: E501
        """get_draft_picks  # noqa: E501

        Returns historical NFL Draft picks.  # noqa: E501
    ...
    def get_draft_positions(self, **kwargs) -> List[DraftPosition]:  # noqa: E501
        ...
        Returns the player position categories used in NFL Draft data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_draft_teams(self, **kwargs) -> List[DraftTeam]:  # noqa: E501
        ...
        Returns the NFL teams represented in draft data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
