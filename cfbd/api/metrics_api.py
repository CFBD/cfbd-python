...
class MetricsApi:
    ...
    def get_field_goal_expected_points(self, **kwargs) -> List[FieldGoalEP]:  # noqa: E501
        ...
        Returns expected points values for field goal attempts.  # noqa: E501
    ...
    @validate_arguments
    def get_predicted_points(self, down : Annotated[StrictInt, Field(..., description="Down number.")], distance : Annotated[StrictInt, Field(..., description="Distance to gain, in yards.")], **kwargs) -> List[PredictedPointsValue]:  # noqa: E501
        """get_predicted_points  # noqa: E501

        Returns predicted points values by down and distance.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param down: Down number. (required)
        :type down: int
        :param distance: Distance to gain, in yards. (required)
        :type distance: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
    ...
    @validate_arguments
    def get_predicted_points_with_http_info(self, down : Annotated[StrictInt, Field(..., description="Down number.")], distance : Annotated[StrictInt, Field(..., description="Distance to gain, in yards.")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_predicted_points  # noqa: E501
    ...
    @validate_arguments
    def get_predicted_points_added_by_game(self, year : Annotated[StrictInt, Field(..., description="Season year.")], week : Annotated[Optional[StrictInt], Field(description="Week number.")] = None, season_type : Annotated[Optional[SeasonType], Field(description="Season type.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Division classification. Defaults to `fbs`.")] = None, **kwargs) -> List[TeamGamePredictedPointsAdded]:  # noqa: E501
        """get_predicted_points_added_by_game  # noqa: E501

        Returns team Predicted Points Added (PPA) metrics by game.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_predicted_points_added_by_game(year, week, season_type, team, conference, exclude_garbage_time, classification, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_predicted_points_added_by_game_with_http_info(year, week, season_type, team, conference, exclude_garbage_time, classification, **kwargs)  # noqa: E501
    ...
    def get_predicted_points_added_by_game_with_http_info(self, year : Annotated[StrictInt, Field(..., description="Season year.")], week : Annotated[Optional[StrictInt], Field(description="Week number.")] = None, season_type : Annotated[Optional[SeasonType], Field(description="Season type.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Division classification. Defaults to `fbs`.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_predicted_points_added_by_game_with_http_info(year, week, season_type, team, conference, exclude_garbage_time, classification, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_predicted_points_added_by_player_game(self, year : Annotated[StrictInt, Field(..., description="Season year.")], week : Annotated[Optional[StrictInt], Field(description="Week number. Required unless `team` is specified.")] = None, season_type : Annotated[Optional[SeasonType], Field(description="Season type.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name. Required unless `week` is specified.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, player_id : Annotated[Optional[StrictStr], Field(description="Player ID.")] = None, threshold : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Minimum number of plays.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, **kwargs) -> List[PlayerGamePredictedPointsAdded]:  # noqa: E501
        """get_predicted_points_added_by_player_game  # noqa: E501

        Returns player Predicted Points Added (PPA) metrics by game.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_predicted_points_added_by_player_season(self, year : Annotated[Optional[StrictInt], Field(description="Season year. Required unless `playerId` is specified.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name.")] = None, position : Annotated[Optional[StrictStr], Field(description="Player position abbreviation.")] = None, player_id : Annotated[Optional[StrictStr], Field(description="Player ID. Required unless `year` is specified.")] = None, threshold : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Minimum number of plays.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, **kwargs) -> List[PlayerSeasonPredictedPointsAdded]:  # noqa: E501
        """get_predicted_points_added_by_player_season  # noqa: E501

        Returns player Predicted Points Added (PPA) metrics by season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_predicted_points_added_by_team(self, year : Annotated[Optional[StrictInt], Field(description="Season year. Required unless `team` is specified.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name. Required unless `year` is specified.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Division classification. Defaults to `fbs`.")] = None, **kwargs) -> List[TeamSeasonPredictedPointsAdded]:  # noqa: E501
        ...
        Returns team Predicted Points Added (PPA) metrics by season.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_predicted_points_added_by_team(year, team, conference, exclude_garbage_time, classification, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_predicted_points_added_by_team_with_http_info(year, team, conference, exclude_garbage_time, classification, **kwargs)  # noqa: E501
    ...
    def get_predicted_points_added_by_team_with_http_info(self, year : Annotated[Optional[StrictInt], Field(description="Season year. Required unless `team` is specified.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name. Required unless `year` is specified.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference abbreviation.")] = None, exclude_garbage_time : Annotated[Optional[StrictBool], Field(description="Excludes garbage-time plays when `true`.")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Division classification. Defaults to `fbs`.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_predicted_points_added_by_team_with_http_info(year, team, conference, exclude_garbage_time, classification, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_win_probability(self, game_id : Annotated[StrictInt, Field(..., description="Game ID.")], **kwargs) -> List[PlayWinProbability]:  # noqa: E501
        """get_win_probability  # noqa: E501

        Returns play-by-play win probabilities for a game.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_win_probability_with_http_info(self, game_id : Annotated[StrictInt, Field(..., description="Game ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """get_win_probability  # noqa: E501
