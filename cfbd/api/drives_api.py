...
class DrivesApi:
    ...
    @validate_arguments
    def get_drives(self, year : Annotated[StrictInt, Field(..., description="Season year.")], season_type : Annotated[Optional[SeasonType], Field(description="Season type.")] = None, week : Annotated[Optional[StrictInt], Field(description="Week number.")] = None, team : Annotated[Optional[StrictStr], Field(description="Team name on either side of the drive.")] = None, offense : Annotated[Optional[StrictStr], Field(description="Offensive team name.")] = None, defense : Annotated[Optional[StrictStr], Field(description="Defensive team name.")] = None, conference : Annotated[Optional[StrictStr], Field(description="Conference of either team.")] = None, offense_conference : Annotated[Optional[StrictStr], Field(description="Offensive team conference.")] = None, defense_conference : Annotated[Optional[StrictStr], Field(description="Defensive team conference.")] = None, classification : Annotated[Optional[DivisionClassification], Field(description="Division classification of either team.")] = None, **kwargs) -> List[Drive]:  # noqa: E501
        """get_drives  # noqa: E501

        Returns historical drive data.  # noqa: E501
