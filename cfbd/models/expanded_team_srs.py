...
class ExpandedTeamSRS(BaseModel):
    """
    ExpandedTeamSRS
    """
    ...
    classification: DivisionClassification = Field(...)
    __properties = ["year", "team", "conference", "division", "rating", "ranking", "classification"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpandedTeamSRS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpandedTeamSRS:
        """Create an instance of ExpandedTeamSRS from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpandedTeamSRS.parse_obj(obj)

        _obj = ExpandedTeamSRS.parse_obj({
            "year": obj.get("year"),
            "team": obj.get("team"),
