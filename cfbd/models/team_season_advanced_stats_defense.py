...
class TeamSeasonAdvancedStatsDefense(BaseModel):
    """
    ...
    passing_downs: TeamSeasonAdvancedStatsOffensePassingPlays = Field(default=..., alias="passingDowns")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamSeasonAdvancedStatsDefense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamSeasonAdvancedStatsDefense:
        """Create an instance of TeamSeasonAdvancedStatsDefense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamSeasonAdvancedStatsDefense.parse_obj(obj)

        _obj = TeamSeasonAdvancedStatsDefense.parse_obj({
            ...
            "passing_downs": TeamSeasonAdvancedStatsOffensePassingPlays.from_dict(obj.get("passingDowns")) if obj.get("passingDowns") is not None else None,
