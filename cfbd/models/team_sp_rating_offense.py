...
class TeamSPRatingOffense(object):
    ...
    def __init__(self, ranking=None, rating=None, success=None, explosiveness=None, rushing=None, passing=None, standard_downs=None, passing_downs=None, run_rate=None, pace=None):  # noqa: E501
