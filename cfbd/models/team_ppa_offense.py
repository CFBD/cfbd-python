...
class TeamPPAOffense(object):
    ...
    def __init__(self, overall=None, passing=None, rushing=None, first_down=None, second_down=None, third_down=None, cumulative=None, _configuration=None):  # noqa: E501
