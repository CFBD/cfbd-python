...
class TeamRushingGame(BaseModel):
    """
    TeamRushingGame
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamRushingGame:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamRushingGame:
        """Create an instance of TeamRushingGame from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamRushingGame.parse_obj(obj)

        _obj = TeamRushingGame.parse_obj({
