...
class ScoreboardGameHomeTeam(BaseModel):
    ...
    """
    line_score: Optional[conlist(StrictInt)] = Field(default=..., alias="lineScore")
    ...
    id: StrictInt = Field(...)
    __properties = ["lineScore", "points", "classification", "conference", "name", "id"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if line_score (nullable) is None
        # and __fields_set__ contains the field
        if self.line_score is None and "line_score" in self.__fields_set__:
            _dict['lineScore'] = None
