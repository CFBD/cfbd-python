...
class ScoreboardGameHomeTeam(BaseModel):
    ...
    """
    win_probability: Optional[Union[StrictFloat, StrictInt]] = Field(default=..., alias="winProbability")
    ...
    id: StrictInt = Field(...)
    __properties = ["winProbability", "lineScores", "points", "classification", "conference", "name", "id"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if win_probability (nullable) is None
        # and __fields_set__ contains the field
        if self.win_probability is None and "win_probability" in self.__fields_set__:
            _dict['winProbability'] = None
    ...
    def from_dict(cls, obj: dict) -> ScoreboardGameHomeTeam:
        ...
        _obj = ScoreboardGameHomeTeam.parse_obj({
            "win_probability": obj.get("winProbability"),
