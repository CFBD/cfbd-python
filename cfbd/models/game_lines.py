...
class GameLines(object):
    ...
    def __init__(self, id=None, season=None, week=None, season_type=None, home_team=None, home_conference=None, home_score=None, away_team=None, away_conference=None, away_score=None, lines=None, _configuration=None):  # noqa: E501
