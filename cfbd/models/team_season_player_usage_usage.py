...
class TeamSeasonPlayerUsageUsage(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamSeasonPlayerUsageUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamSeasonPlayerUsageUsage:
        """Create an instance of TeamSeasonPlayerUsageUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamSeasonPlayerUsageUsage.parse_obj(obj)

        _obj = TeamSeasonPlayerUsageUsage.parse_obj({
