...
class Game(BaseModel):
    ...
    home_line_scores: Optional[conlist(Union[StrictFloat, StrictInt], min_items=4)] = Field(default=..., alias="homeLineScores")
    ...
    away_line_scores: Optional[conlist(Union[StrictFloat, StrictInt], min_items=4)] = Field(default=..., alias="awayLineScores")
