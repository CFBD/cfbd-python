...
class Game(object):
    ...
    def __init__(self, id=None, season=None, week=None, season_type=None, start_date=None, start_time_tbd=None, neutral_site=None, conference_game=None, attendance=None, venue_id=None, venue=None, home_id=None, home_team=None, home_conference=None, home_division=None, home_points=None, home_line_scores=None, home_post_win_prob=None, home_pregame_elo=None, home_postgame_elo=None, away_id=None, away_team=None, away_conference=None, away_division=None, away_points=None, away_line_scores=None, away_post_win_prob=None, away_pregame_elo=None, away_postgame_elo=None, excitement_index=None, highlights=None, notes=None, _configuration=None):  # noqa: E501
