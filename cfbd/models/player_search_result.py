...
class PlayerSearchResult(object):
    ...
    def __init__(self, id=None, team=None, name=None, first_name=None, last_name=None, weight=None, height=None, jersey=None, position=None, hometown=None, team_color=None):  # noqa: E501
