...
class TeamSeasonAdvancedStatsOffense(BaseModel):
    """
    TeamSeasonAdvancedStatsOffense
    """
    passing_plays: TeamSeasonAdvancedStatsOffensePassingPlays = Field(default=..., alias="passingPlays")
    rushing_plays: TeamSeasonAdvancedStatsOffensePassingPlays = Field(default=..., alias="rushingPlays")
    passing_downs: TeamSeasonAdvancedStatsOffensePassingDowns = Field(default=..., alias="passingDowns")
    standard_downs: TeamSeasonAdvancedStatsOffensePassingDowns = Field(default=..., alias="standardDowns")
    havoc: TeamSeasonAdvancedStatsOffenseHavoc = Field(...)
    field_position: TeamSeasonAdvancedStatsOffenseFieldPosition = Field(default=..., alias="fieldPosition")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamSeasonAdvancedStatsOffense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamSeasonAdvancedStatsOffense:
        """Create an instance of TeamSeasonAdvancedStatsOffense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamSeasonAdvancedStatsOffense.parse_obj(obj)

        _obj = TeamSeasonAdvancedStatsOffense.parse_obj({
            "passing_plays": TeamSeasonAdvancedStatsOffensePassingPlays.from_dict(obj.get("passingPlays")) if obj.get("passingPlays") is not None else None,
            "rushing_plays": TeamSeasonAdvancedStatsOffensePassingPlays.from_dict(obj.get("rushingPlays")) if obj.get("rushingPlays") is not None else None,
            "passing_downs": TeamSeasonAdvancedStatsOffensePassingDowns.from_dict(obj.get("passingDowns")) if obj.get("passingDowns") is not None else None,
            "standard_downs": TeamSeasonAdvancedStatsOffensePassingDowns.from_dict(obj.get("standardDowns")) if obj.get("standardDowns") is not None else None,
            "havoc": TeamSeasonAdvancedStatsOffenseHavoc.from_dict(obj.get("havoc")) if obj.get("havoc") is not None else None,
            "field_position": TeamSeasonAdvancedStatsOffenseFieldPosition.from_dict(obj.get("fieldPosition")) if obj.get("fieldPosition") is not None else None,
