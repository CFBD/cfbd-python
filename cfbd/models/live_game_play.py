...
class LiveGamePlay(BaseModel):
    ...
    rush_pass: StrictStr = Field(default=..., alias="rushPass")
    down_type: StrictStr = Field(default=..., alias="downType")
    play_text: StrictStr = Field(default=..., alias="playText")
    __properties = ["id", "homeScore", "awayScore", "period", "clock", "wallClock", "teamId", "team", "down", "distance", "yardsToGoal", "yardsGained", "playTypeId", "playType", "epa", "garbageTime", "success", "rushPass", "downType", "playText"]

    @validator('rush_pass')
    def rush_pass_validate_enum(cls, value):
        """Validates the enum"""
