...
class AdvancedBoxScorePlayers(BaseModel):
    ...
    rushing: conlist(PlayerRushingGame) = Field(default=..., description="Enriched rushing by athlete ID, including direction coverage.")
    passing: conlist(PlayerPassingGame) = Field(default=..., description="Enriched passing by athlete ID, including location coverage.")
    __properties = ["ppa", "usage", "rushing", "passing"]
    ...
    def from_dict(cls, obj: dict) -> AdvancedBoxScorePlayers:
        ...
        _obj = AdvancedBoxScorePlayers.parse_obj({
            ...
            "rushing": [PlayerRushingGame.from_dict(_item) for _item in obj.get("rushing")] if obj.get("rushing") is not None else None,
            "passing": [PlayerPassingGame.from_dict(_item) for _item in obj.get("passing")] if obj.get("passing") is not None else None
        })
        return _obj
