...
class GameMedia(object):
    ...
    def __init__(self, id=None, season=None, week=None, season_type=None, start_time=None, is_start_time_tbd=None, home_team=None, home_conference=None, away_team=None, away_conference=None, media_type=None, outlet=None):  # noqa: E501
