...
class TeamSPRating(object):
    ...
    def __init__(self, year=None, team=None, conference=None, rating=None, ranking=None, second_order_wins=None, sos=None, offense=None, defense=None, special_teams=None):  # noqa: E501
