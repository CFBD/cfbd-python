...
class PlayerSeasonPredictedPointsAdded(BaseModel):
    ...
    average_ppa: PlayerSeasonOverviewPPAAverage = Field(default=..., alias="averagePPA")
    total_ppa: PlayerSeasonOverviewPPAAverage = Field(default=..., alias="totalPPA")
    ...
    def from_dict(cls, obj: dict) -> PlayerSeasonPredictedPointsAdded:
        ...
        _obj = PlayerSeasonPredictedPointsAdded.parse_obj({
            ...
            "average_ppa": PlayerSeasonOverviewPPAAverage.from_dict(obj.get("averagePPA")) if obj.get("averagePPA") is not None else None,
            "total_ppa": PlayerSeasonOverviewPPAAverage.from_dict(obj.get("totalPPA")) if obj.get("totalPPA") is not None else None
        })
        return _obj
