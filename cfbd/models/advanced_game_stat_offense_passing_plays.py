...
class AdvancedGameStatOffensePassingPlays(BaseModel):
    """
    ...
    __properties = ["explosiveness", "successRate", "totalPPA", "ppa"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdvancedGameStatOffensePassingPlays:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdvancedGameStatOffensePassingPlays:
        """Create an instance of AdvancedGameStatOffensePassingPlays from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdvancedGameStatOffensePassingPlays.parse_obj(obj)

        _obj = AdvancedGameStatOffensePassingPlays.parse_obj({
