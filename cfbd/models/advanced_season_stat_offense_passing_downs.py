...
class AdvancedSeasonStatOffensePassingDowns(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdvancedSeasonStatOffensePassingDowns:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdvancedSeasonStatOffensePassingDowns:
        """Create an instance of AdvancedSeasonStatOffensePassingDowns from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdvancedSeasonStatOffensePassingDowns.parse_obj(obj)

        _obj = AdvancedSeasonStatOffensePassingDowns.parse_obj({
