...
class Drive(BaseModel):
    ...
    __properties = ["offense", "offenseConference", "defense", "defenseConference", "gameId", "id", "driveNumber", "scoring", "startPeriod", "startYardline", "startYardsToGoal", "startTime", "endPeriod", "endYardline", "endYardsToGoal", "endTime", "elapsed", "plays", "yards", "driveResult", "isHomeOffense", "startOffenseScore", "startDefenseScore", "endOffenseScore", "endDefenseScore"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of elapsed
        if self.elapsed:
            _dict['elapsed'] = self.elapsed.to_dict()
    ...
    def from_dict(cls, obj: dict) -> Drive:
        ...
        _obj = Drive.parse_obj({
            ...
            "elapsed": PlayClock.from_dict(obj.get("elapsed")) if obj.get("elapsed") is not None else None,
            "plays": obj.get("plays"),
            "yards": obj.get("yards"),
