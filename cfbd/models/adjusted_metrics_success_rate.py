...
class AdjustedMetricsSuccessRate(BaseModel):
    """
    AdjustedMetricsSuccessRate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdjustedMetricsSuccessRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdjustedMetricsSuccessRate:
        """Create an instance of AdjustedMetricsSuccessRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdjustedMetricsSuccessRate.parse_obj(obj)

        _obj = AdjustedMetricsSuccessRate.parse_obj({
