...
class TeamSeasonPlayerPpaValues(BaseModel):
    """
    TeamSeasonPlayerPpaValues
    """
    all: Optional[Union[StrictFloat, StrictInt]] = Field(...)
    ...
    __properties = ["all", "pass", "rush", "firstDown", "secondDown", "thirdDown", "standardDowns", "passingDowns"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamSeasonPlayerPpaValues:
    ...
    def to_dict(self):
        ...
        if self.all is None and "all" in self.__fields_set__:
            _dict['all'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamSeasonPlayerPpaValues:
        """Create an instance of TeamSeasonPlayerPpaValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamSeasonPlayerPpaValues.parse_obj(obj)

        _obj = TeamSeasonPlayerPpaValues.parse_obj({
            "all": obj.get("all"),
