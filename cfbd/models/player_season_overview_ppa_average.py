...
class PlayerSeasonOverviewPPAAverage(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlayerSeasonOverviewPPAAverage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlayerSeasonOverviewPPAAverage:
        """Create an instance of PlayerSeasonOverviewPPAAverage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlayerSeasonOverviewPPAAverage.parse_obj(obj)

        _obj = PlayerSeasonOverviewPPAAverage.parse_obj({
