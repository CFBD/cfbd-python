...
class AdvancedGameStatOffense(BaseModel):
    """
    ...
    open_field_yards: Optional[Union[StrictFloat, StrictInt]] = Field(default=..., alias="openFieldYards")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdvancedGameStatOffense:
    ...
    def to_dict(self):
        ...
        # set to None if open_field_yards (nullable) is None
        # and __fields_set__ contains the field
        if self.open_field_yards is None and "open_field_yards" in self.__fields_set__:
            _dict['openFieldYards'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdvancedGameStatOffense:
        """Create an instance of AdvancedGameStatOffense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdvancedGameStatOffense.parse_obj(obj)

        _obj = AdvancedGameStatOffense.parse_obj({
