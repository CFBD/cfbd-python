...
class LivePlayByPlay(object):
    ...
    def __init__(self, id=None, status=None, period=None, clock=None, possession=None, down=None, distance=None, yards_to_goal=None, teams=None, plays=None, _configuration=None):  # noqa: E501
