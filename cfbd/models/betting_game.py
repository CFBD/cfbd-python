...
class BettingGame(BaseModel):
    ...
    __properties = ["id", "season", "seasonType", "week", "startDate", "homeTeamId", "homeTeam", "homeConference", "homeClassification", "homeScore", "awayTeamId", "awayTeam", "awayConference", "awayClassification", "awayScore", "lines"]
