...
class TeamSPDefense(BaseModel):
    ...
    __properties = ["havoc", "passingDowns", "standardDowns", "passing", "rushing", "explosiveness", "success", "rating", "ranking"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamSPDefense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamSPDefense:
        """Create an instance of TeamSPDefense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamSPDefense.parse_obj(obj)

        _obj = TeamSPDefense.parse_obj({
