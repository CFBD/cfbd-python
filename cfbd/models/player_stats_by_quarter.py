...
class PlayerStatsByQuarter(BaseModel):
    """
    ...
    __properties = ["total", "quarter1", "quarter2", "quarter3", "quarter4", "rushing", "passing"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlayerStatsByQuarter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlayerStatsByQuarter:
        """Create an instance of PlayerStatsByQuarter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlayerStatsByQuarter.parse_obj(obj)

        _obj = PlayerStatsByQuarter.parse_obj({
            "total": obj.get("total"),
