...
class AdjustedMetricsEpa(BaseModel):
    """
    AdjustedMetricsEpa
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdjustedMetricsEpa:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdjustedMetricsEpa:
        """Create an instance of AdjustedMetricsEpa from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdjustedMetricsEpa.parse_obj(obj)

        _obj = AdjustedMetricsEpa.parse_obj({
