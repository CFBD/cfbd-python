...
class ConferenceSPOffense(BaseModel):
    """
    ConferenceSPOffense
    """
    ...
    __properties = ["pace", "runRate", "passingDowns", "standardDowns", "passing", "rushing", "explosiveness", "success", "rating"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConferenceSPOffense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConferenceSPOffense:
        """Create an instance of ConferenceSPOffense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConferenceSPOffense.parse_obj(obj)

        _obj = ConferenceSPOffense.parse_obj({
            "pace": obj.get("pace"),
