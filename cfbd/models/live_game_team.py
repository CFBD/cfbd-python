...
class LiveGameTeam(BaseModel):
    ...
    average_start_yard_line: Optional[Union[StrictFloat, StrictInt]] = Field(default=..., alias="averageStartYardLine")
    ...
    deserve_to_win: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="deserveToWin", description="Deserve-to-win metric for this team")
    __properties = ["teamId", "team", "homeAway", "lineScores", "points", "drives", "scoringOpportunities", "pointsPerOpportunity", "averageStartYardLine", "plays", "lineYards", "lineYardsPerRush", "secondLevelYards", "secondLevelYardsPerRush", "openFieldYards", "openFieldYardsPerRush", "epaPerPlay", "totalEpa", "passingEpa", "epaPerPass", "rushingEpa", "epaPerRush", "successRate", "standardDownSuccessRate", "passingDownSuccessRate", "explosiveness", "deserveToWin"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if average_start_yard_line (nullable) is None
        # and __fields_set__ contains the field
        if self.average_start_yard_line is None and "average_start_yard_line" in self.__fields_set__:
            _dict['averageStartYardLine'] = None
    ...
    def from_dict(cls, obj: dict) -> LiveGameTeam:
        ...
        _obj = LiveGameTeam.parse_obj({
            ...
            "average_start_yard_line": obj.get("averageStartYardLine"),
            "plays": obj.get("plays"),
            ...
            "deserve_to_win": obj.get("deserveToWin")
        })
        return _obj
