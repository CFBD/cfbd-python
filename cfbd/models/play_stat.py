...
class PlayStat(object):
    ...
    def __init__(self, game_id=None, season=None, week=None, team=None, conference=None, opponent=None, team_score=None, opponent_score=None, drive_id=None, play_id=None, period=None, clock=None, yards_to_goal=None, down=None, distance=None, athlete_id=None, athlete_name=None, stat_type=None, stat=None):  # noqa: E501
