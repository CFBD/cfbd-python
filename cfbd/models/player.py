...
class Player(object):
    ...
    def __init__(self, id=None, first_name=None, last_name=None, team=None, height=None, weight=None, jersey=None, year=None, position=None, city=None, state=None, country=None):  # noqa: E501
