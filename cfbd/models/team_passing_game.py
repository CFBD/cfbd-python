...
class TeamPassingGame(BaseModel):
    """
    TeamPassingGame
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TeamPassingGame:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TeamPassingGame:
        """Create an instance of TeamPassingGame from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TeamPassingGame.parse_obj(obj)

        _obj = TeamPassingGame.parse_obj({
